...
@Service
public class LoginVerify implements com.benniao.service.LoginVerify {
    ...
    public Account verify(String un, String pw, Integer ut) throws IOException {
        ...
        switch (ut) {
            case 1:
                SystemAdmin sa  = systemAdminMapper.findByUsername1(un);
                if (sa == null) {
                ...
                break;
            case 0:
                CommonUser cu  = commonUserMapper.findByUsername2(un);
                if (cu == null) {
                    System.out.println("账户不存在");
                    account.loginStatus = 1;
                } else {
